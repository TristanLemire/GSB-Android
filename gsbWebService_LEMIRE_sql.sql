...
--
-- Host: localhost    Database: GsbCRSlamV20152
-- ------------------------------------------------------
...
--
-- Table structure for table `COEFFICIENT_CONFIANCE`
--

DROP TABLE IF EXISTS `COEFFICIENT_CONFIANCE`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `COEFFICIENT_CONFIANCE` (
  `COE_ID` int(11) NOT NULL,
  `COE_LIBELLE` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`COE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `COEFFICIENT_CONFIANCE`
--

LOCK TABLES `COEFFICIENT_CONFIANCE` WRITE;
/*!40000 ALTER TABLE `COEFFICIENT_CONFIANCE` DISABLE KEYS */;
INSERT INTO `COEFFICIENT_CONFIANCE` VALUES (1,'Hésitant'),(2,'Neutre'),(3,'Confiant');
/*!40000 ALTER TABLE `COEFFICIENT_CONFIANCE` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `CONSTITUER` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_CONSTITUER_MEDICAMENT` (`MED_DEPOTLEGAL`),
...
CREATE TABLE `FORMULER` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_FORMULER_MEDICAMENT` (`MED_DEPOTLEGAL`),
...
CREATE TABLE `INTERAGIR` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_INTERAGIR_PERTURBATEUR_MEDICAMENT` (`MED_PERTURBATEUR`),
...
CREATE TABLE `INVITER` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_INVITER_ACTIVITE_COMPL` (`AC_NUM`),
...
INSERT INTO `MOTIF` VALUES (1,'Périodicité'),(2,'Nouveauté'),(3,'Actualisation'),(4,'Remontage'),(5,'Demande de visite'),(6,'Autre');
...
CREATE TABLE `OFFRIR` (
  ...
  `MED_DEPOTLEGAL` varchar(20) NOT NULL DEFAULT '',
  `OFF_QTE` int(4) DEFAULT '0',
  PRIMARY KEY (`ID`),
  KEY `FK_OFFRIR_MEDICAMENT` (`MED_DEPOTLEGAL`),
  KEY `FK_OFFRIR_VISITEUR` (`VIS_MATRICULE`),
  KEY `FK_OFFRIR_RAPPORT_VISITE_RAPPORT` (`RAP_NUM`),
  CONSTRAINT `FK_OFFRIR_MEDICAMENT` FOREIGN KEY (`MED_DEPOTLEGAL`) REFERENCES `MEDICAMENT` (`MED_DEPOTLEGAL`),
  CONSTRAINT `FK_OFFRIR_RAPPORT_VISITE_RAPPORT` FOREIGN KEY (`RAP_NUM`) REFERENCES `RAPPORT_VISITE` (`RAP_NUM`),
...
INSERT INTO `OFFRIR` VALUES (1,'a17',1,'3MYC7',10),(2,'a17',1,'AMOX45',52),(3,'a17',9,'ADIMOL9',9),(4,'a17',16,'3MYC7',5),(5,'a17',16,'ADIMOL9',2),(6,'a17',16,'AMOPIL7',1),(7,'a17',17,'3MYC7',1),(8,'a17',17,'ADIMOL9',2),(9,'a17',17,'AMOPIL7',3),(10,'a17',17,'AMOX45',4),(11,'a17',17,'APATOUX22',5);
...
CREATE TABLE `POSSEDER` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_POSSEDER_PRATICIEN` (`PRA_NUM`),
...
CREATE TABLE `RAPPORT_VISITE` (
  ...
  `RAP_LECTURE` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`RAP_NUM`),
  KEY `FK_RAPPORT_VISITE_VISITEUR` (`VIS_MATRICULE`),
  KEY `FK_RAPPORT_VISITE_PRATICIEN` (`PRA_NUM`),
  KEY `FK_RAPPORT_VISITE_MOTIF` (`MOT_ID`),
  KEY `FK_RAPPORT_VISITE_COEFFICIENT_CONFIANCE` (`COE_ID`),
  CONSTRAINT `FK_RAPPORT_VISITE_COEFFICIENT_CONFIANCE` FOREIGN KEY (`COE_ID`) REFERENCES `COEFFICIENT_CONFIANCE` (`COE_ID`),
  CONSTRAINT `FK_RAPPORT_VISITE_MOTIF` FOREIGN KEY (`MOT_ID`) REFERENCES `MOTIF` (`MOT_ID`),
...
INSERT INTO `RAPPORT_VISITE` VALUES (1,'a17',83,'2016-09-15','Client hésitant donc remontage important. Prospectus bien en vue du laboratoire concurrent.',4,'2016-09-13',1,0),(2,'p42',4,'2016-05-16','Client confiant. Échantillons de notre laboratoire visibles.',2,'2016-05-14',3,0),(3,'b19',1,'2016-10-03','Client confiant. Affiches concurrentes sur les murs.',3,'2016-10-02',2,0),(4,'g53',28,'2016-02-26','Client hésitant. Remontage nécessaire. Échantillons et prospectus concurrents en vue.',4,'2016-02-25',1,0),(5,'d13',19,'2016-01-13','Client confiant. Affiches du laboratoire concurrent visibles.',1,'2016-01-10',3,1),(6,'e39',13,'2016-09-01','Client confiant. Prospectus du laboratoire concurrent.',1,'2016-09-01',3,0),(7,'e39',53,'2016-09-15','Client confiant. Échantillons du laboratoire concurrent.',1,'2016-09-15',3,0),(8,'e39',13,'2016-09-26','Client hésitant. Prospectus, échantillons et affiches du laboratoire concurrent.',4,'2016-09-25',1,0),(9,'a17',2,'2017-04-25','ok2',2,'2017-05-24',2,0),(10,'a17',3,'2017-05-03','ok3',1,'2017-05-03',1,0),(11,'a17',2,'2017-05-03','testOffre',1,'2017-05-09',1,0),(12,'a17',2,'2017-05-03','testOffre',1,'2017-05-09',1,0),(13,'a17',3,'2017-05-03','test4',1,'2017-05-06',1,0),(14,'a17',1,'2017-05-03','test5',1,'2017-06-09',1,0),(15,'a17',4,'2017-05-03','test5',3,'2017-05-04',3,0),(16,'a17',7,'2017-05-03','test6',5,'2017-05-06',3,0),(17,'a17',2,'2017-05-04','test8',1,'2017-05-06',1,0),(18,'a17',1,'2017-05-13','test2',1,'2017-05-19',1,0);
...
CREATE TABLE `REALISER` (
  ...
  `VIS_MATRICULE` varchar(20) NOT NULL DEFAULT '',
  PRIMARY KEY (`ID`),
  KEY `FK_REALISER_ACTIVITE_COMPL` (`AC_NUM`),
...
CREATE TABLE `TRAVAILLER` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_TRAVAILLER_VISITEUR` (`VIS_MATRICULE`),
...
INSERT INTO `TRAVAILLER` VALUES (1,'p49','2014-02-20','CE','Visiteur'),(2,'k53','2014-02-20','CA','Visiteur'),(3,'r24','2014-02-20','BN','Visiteur'),(4,'g53','2014-02-20','BG','Visiteur'),(5,'m35','2014-03-12','MP','Visiteur'),(6,'e39','2014-03-12','IF','Visiteur'),(7,'e22','2014-03-12','AL','Visiteur'),(8,'p7','2014-03-12','RO','Visiteur'),(9,'r58','2014-03-12','BG','Visiteur'),(10,'m45','2014-03-12','AL','Visiteur'),(11,'t60','2014-03-12','CE','Visiteur'),(12,'c54','2014-01-05','AL','Visiteur'),(13,'p8','2014-01-05','BO','Visiteur'),(14,'a17','2014-01-05','RA','Visiteur'),(15,'e52','2014-01-05','HN','Visiteur'),(16,'d13','2014-01-05','PL','Visiteur'),(17,'k53','2014-01-05','AL','Délégué'),(18,'c3','2014-01-05','CA','Visiteur'),(19,'n58','2014-01-05','CE','Visiteur'),(20,'s21','2014-01-05','LI','Visiteur'),(21,'h40','2014-01-05','CA','Visiteur'),(22,'a131','2014-01-05','BN','Visiteur'),(23,'j50','2014-01-05','NP','Visiteur'),(24,'p32','2014-01-20','IF','Visiteur'),(25,'h13','2014-01-20','LI','Visiteur'),(26,'f21','2014-01-20','RA','Visiteur'),(27,'h35','2014-01-20','AU','Visiteur'),(28,'b34','2014-01-20','CE','Délégué'),(29,'f4','2014-03-02','MP','Visiteur'),(30,'b25','2014-03-02','PL','Visiteur'),(31,'t55','2014-03-02','MP','Visiteur'),(32,'p42','2014-03-02','PI','Visiteur'),(33,'n59','2014-03-02','PI','Visiteur'),(34,'o26','2014-03-02','LG','Visiteur'),(35,'l14','2014-03-02','PL','Visiteur'),(36,'t43','2014-03-02','BO','Visiteur'),(37,'a55','2014-03-02','RO','Visiteur'),(38,'l23','2014-03-02','PC','Visiteur'),(39,'b59','2014-03-02','RA','Visiteur'),(40,'s10','2014-03-03','FC','Visiteur'),(41,'g7','2014-03-03','LI','Visiteur'),(42,'g19','2014-03-03','IF','Visiteur'),(43,'e49','2014-03-03','MP','Visiteur'),(44,'l56','2014-03-03','FC','Visiteur'),(45,'n42','2014-03-03','HN','Visiteur'),(46,'b13','2014-03-03','AL','Visiteur'),(47,'a131','2014-03-03','BG','Visiteur'),(48,'k4','2014-03-03','LG','Visiteur'),(49,'l46','2014-03-03','PL','Visiteur'),(50,'c14','2014-04-04','PA','Délégué'),(51,'f39','2014-04-04','RA','Visiteur'),(52,'b16','2014-04-04','BG','Visiteur'),(53,'p6','0000-00-00','AQ','Visiteur'),(54,'t47','2004-05-02','PI','Visiteur'),(55,'q17','2003-03-01','BN','Visiteur'),(56,'b4','2003-03-01','AQ','Visiteur'),(57,'b50','2003-03-01','PA','Visiteur'),(58,'j45','2003-03-01','CA','Responsable'),(59,'h30','2003-03-01','IF','Visiteur'),(60,'j8','2008-02-10','IF','Responsable'),(61,'p41','2008-02-10','PC','Visiteur'),(62,'a93','2008-02-10','PC','Visiteur'),(63,'b19','2008-02-10','PL','Visiteur'),(64,'p40','2008-02-10','BN','Responsable'),(65,'b25','2001-01-00','PL','Délégué'),(66,'e24','2008-02-10','AL','Responsable'),(67,'b28','2008-02-10','LG','Visiteur'),(68,'g30','2003-03-01','PI','Responsable'),(69,'e5','2003-03-01','AQ','Responsable'),(70,'c14','2003-03-01','PA','Responsable'),(71,'d51','2003-03-01','FC','Responsable');
...
CREATE TABLE `VISITEUR` (
  ...
  `VIS_CONNECTE` tinyint(1) DEFAULT '0',
  `VIS_LOGIN` varchar(8) DEFAULT NULL,
  `VIS_MDP` varchar(40) DEFAULT 'azerty',
  `VIS_TOKEN` text,
...
INSERT INTO `VISITEUR` VALUES ('a131','Villechalane','Louis','8 cours Lafontaine','29000','BREST','2012-11-08',NULL,'SW',0,'lvillech','azerty',NULL),('a17','Andre','David','1 rue Aimon de Chissee','38100','GRENOBLE','2008-06-19',NULL,'GY',1,'dandre17','azerty','cKQz3b0pM8w:APA91bFyOfpJongLrL-t40eJM8XTsVmaflqct4xIx6ZgY1Z6nqBvEouEyBJulcQy4guYwmpZ7ZuwRr58y4s5R7G8IoxEFnoaMDEpaFTSan7HYqxAaOdDCe8dCKTmlgdYFXYoCeMg5kLT'),('a55','Bedos','Christian','1 rue Bénédictins','65000','TARBES','2007-09-07',NULL,'GY',0,'cbedos17','azerty',NULL),('a93','Tusseau','Louis','22 rue Renou','86000','POITIERS','2001-02-09',NULL,'SW',0,'ltusseau','azerty',NULL),('b13','Bentot','Pascal','11 avenue 6 Juin','67000','STRASBOURG','2003-11-06',NULL,'GY',0,'pbentot1','azerty',NULL),('b16','Bioret','Luc','1 rue Linne','35000','RENNES','2003-01-06',NULL,'SW',0,'lbioret1','azerty',NULL),('b19','Bunisset','Francis','10 rue Nicolas Chorier','85000','LA ROCHE SUR YON','2013-09-23',NULL,'GY',0,'fbunisse','azerty',NULL),('b25','Bunisset','Denise','1 rue Lionne','49100','ANGERS','2007-03-04',NULL,'SW',0,'dbunisse','azerty',NULL),('b28','Cacheux','Bernard','114 rue Authie','34000','MONTPELLIER','2008-02-10',NULL,'GY',0,'bcacheux','azerty',NULL),('b34','Cadic','Eric','123 rue Caponière','41000','BLOIS','2012-06-03','P','SW',0,'ecadic17','azerty',NULL),('b4','Charoze','Catherine','100 place Géants','33000','BORDEAUX','2009-05-07',NULL,'SW',0,'ccharoze','azerty',NULL),('b50','Clepkens','Christophe','12 rue Fédérico Garcia Lorca','13000','MARSEILLE','2011-08-18',NULL,'SW',0,'cclepken','azerty',NULL),('b59','Cottin','Vincenne','36 square Capucins','5000','GAP','2010-12-19',NULL,'GY',0,'vcottin1','azerty',NULL),('c14','Daburon','François','13 rue Champs Elysées','6000','NICE','2012-01-20','S','SW',0,'fdaburon','azerty',NULL),('c3','De','Philippe','13 rue Charles Peguy','10000','TROYES','2005-05-29',NULL,'SW',0,'pde17','azerty',NULL),('c54','Debelle','Michel','181 rue Caponière','88000','EPINAL','2004-09-19',NULL,'SW',0,'mdebelle','azerty',NULL),('d13','Debelle','Jeanne','134 rue Stalingrad','44000','NANTES','2012-05-25',NULL,'SW',0,'jdebelle','azerty',NULL),('d51','Debroise','Michel','2 avenue 6 Juin','70000','VESOUL','2011-08-17','E','GY',0,'mdebrois','azerty',NULL),('e22','Desmarquest','Nathalie','14 rue Fédérico Garcia Lorca','54000','NANCY','2013-04-18',NULL,'GY',0,'ndesmarq','azerty',NULL),('e24','Desnost','Pierre','16 rue Barral de Montferrat','55000','VERDUN','2013-04-18','E','SW',0,'pdesnost','azerty',NULL),('e39','Dudouit','Frédéric','18 quai Xavier Jouvin','75000','PARIS','2013-04-18',NULL,'GY',1,'fdudouit','azerty',NULL),('e49','Duncombe','Claude','19 avenue Alsace Lorraine','9000','FOIX','2012-09-16',NULL,'GY',0,'cduncomb','azerty',NULL),('e5','Enault-Pascreau','Céline','25B rue Stalingrad','40000','MONT DE MARSAN','2012-09-16','S','GY',0,'cenault-','azerty',NULL),('e52','Eynde','Valérie','3 rue Henri Moissan','76000','ROUEN','2012-09-16',NULL,'GY',0,'veynde17','azerty',NULL),('f21','Finck','Jacques','route Montreuil Bellay','74000','ANNECY','2012-09-16',NULL,'SW',0,'jfinck17','azerty',NULL),('f39','Frémont','Fernande','4 rue Jean Giono','69000','LYON','2005-05-29',NULL,'GY',0,'ffrémont','azerty',NULL),('f4','Gest','Alain','30 rue Authie','46000','FIGEAC','2005-05-29',NULL,'GY',0,'agest17','azerty',NULL),('g19','Gheysen','Galassus','32 boulevard Mar Foch','75000','PARIS','2005-05-29',NULL,'SW',0,'ggheysen','azerty',NULL),('g30','Girard','Yvon','31 avenue du 6 Juin','80000','AMIENS','2012-05-25','N','GY',0,'ygirard1','azerty',NULL),('g53','Gombert','Luc','32 rue Emile Gueymard','56000','VANNES','2012-05-25',NULL,'GY',0,'lgombert','azerty',NULL),('g7','Guindon','Caroline','40 rue Mar Montgomery','87000','LIMOGES','2012-05-25',NULL,'GY',0,'cguindon','azerty',NULL),('h13','Guindon','François','44 rue Picotière','19000','TULLE','2012-05-25',NULL,'SW',0,'fguindon','azerty',NULL),('h30','Igigabel','Guy','33 rue Arlequin','94000','CRETEIL','2008-06-19',NULL,'SW',0,'gigigabe','azerty',NULL),('h35','Jourdren','Pierre','34 avenue Jean Perrot','15000','AURRILLAC','2008-06-19',NULL,'GY',0,'pjourdre','azerty',NULL),('h40','Juttard','Pierre-Raoul','34 cours Jean Jaurès','8000','SEDAN','2008-06-19',NULL,'GY',0,'pjuttard','azerty',NULL),('j45','Euré-Morel','Saout','38 cours Berriat','52000','CHAUMONT','2008-06-19','N','SW',0,'seuré-mo','azerty',NULL),('j50','Landré','Philippe','4 avenue du Général Laperrine','59000','LILLE','2000-05-01',NULL,'GY',0,'plandré1','azerty',NULL),('j8','Langeard','Hugues','39 avenue Jean Perrot','93000','BAGNOLET','2000-05-01','P','GY',0,'hlangear','azerty',NULL),('k4','Lanne','Bernard','4 rue Bayeux','30000','NIMES','2000-05-01',NULL,'SW',0,'blanne17','azerty',NULL),('k53','Le','Noël','4 avenue Beauvert','68000','MULHOUSE','2000-05-01',NULL,'SW',0,'nle17','azerty',NULL),('l14','Le','Jean','39 rue Raspail','53000','LAVAL','2000-05-01',NULL,'SW',0,'jle17','azerty',NULL),('l23','Leclercq','Servane','11 rue Quinconce','18000','BOURGES','1998-11-23',NULL,'SW',0,'sleclerc','azerty',NULL),('l46','Lecornu','Jean-Bernard','4 boulevard du Maréchal Foch','72000','LA FERTE BERNARD','1998-11-23',NULL,'GY',0,'jlecornu','azerty',NULL),('l56','Lecornu','Ludovic','4 rue Abel Servien','25000','BESANCON','1998-11-23',NULL,'SW',0,'llecornu','azerty',NULL),('m35','Lejard','Agnès','4 rue Anthoard','82000','MONTAUBAN','1998-11-23',NULL,'SW',0,'alejard1','azerty',NULL),('m45','Lesaulnier','Pascal','47 rue Thiers','57000','METZ','1998-11-23',NULL,'SW',0,'plesauln','azerty',NULL),('n42','Letessier','Stéphane','5 chemin de Capuche','27000','EVREUX','1998-11-23',NULL,'GY',0,'sletessi','azerty',NULL),('n58','Loirat','Didier','12 avenue Bourg la Croix','45000','ORLEANS','1998-11-23',NULL,'GY',0,'dloirat1','azerty',NULL),('n59','Maffezzoli','Thibaud','5 rue Chateaubriand','2000','LAON','2005-12-21',NULL,'SW',0,'tmaffezz','azerty',NULL),('o26','Mancini','Anne','5 rue D\'\'Agier','48000','MENDE','2005-12-21',NULL,'GY',0,'amancini','azerty',NULL),('p32','Marcouiller','Gérard','7 place St Gilles','91000','ISSY LES MOULINEAUX','2005-12-21',NULL,'GY',0,'gmarcoui','azerty',NULL),('p40','Michel','Jean-Claude','5 rue Gabriel Péri','61000','FLERS','2005-12-21','O','SW',0,'jmichel1','azerty',NULL),('p41','Montecot','Françoise','6 rue Paul Valéry','17000','SAINTES','2005-12-21',NULL,'GY',0,'fmonteco','azerty',NULL),('p42','Notini','Veronique','5 rue du Lieutenant Chabal','60000','BEAUVAIS','2005-12-21',NULL,'SW',0,'vnotini1','azerty',NULL),('p49','Onfroy','Den','5 rue Sidonie Jacolin','37000','TOURS','2005-12-21',NULL,'GY',0,'donfroy1','azerty',NULL),('p6','Pascreau','Charles','57 boulevard Mar Foch','64000','PAU','1997-03-30',NULL,'SW',0,'cpascrea','azerty',NULL),('p7','Pernot','Claude-Noël','6 rue Alexandre 1 de Yougoslavie','11000','NARBONNE','2003-01-02',NULL,'SW',0,'cpernot1','azerty',NULL),('p8','Perrier','Maître','6 rue Aubert Dubayet','71000','CHALON SUR SAONE','2006-06-23',NULL,'GY',0,'mperrier','azerty',NULL),('q17','Petit','Jean-Louis','7 rue Ernest Renan','50000','SAINT LO','2009-06-07',NULL,'GY',0,'jpetit17','azerty',NULL),('r24','Piquery','Patrick','9 rue Vaucelles','14000','CAEN','2007-04-29','O','GY',0,'ppiquery','azerty',NULL),('r58','Quiquandon','Joëll','7 rue Ernest Renan','29000','QUIMPER','2006-09-30',NULL,'GY',0,'jquiquan','azerty',NULL),('s10','Retailleau','Josselin','88 bis rue Saumuroise','39000','DOLE','2011-12-05',NULL,'SW',0,'jretaill','azerty',NULL),('s21','Retailleau','Pascal','32 boulevard Ayrault','23000','MONTLUCON','2009-05-09',NULL,'SW',0,'pretaill','azerty',NULL),('t43','Souron','Maryse','7B rue Gay Lussac','21000','DIJON','2003-09-03',NULL,'SW',0,'msouron1','azerty',NULL),('t47','Tiphagne','Patrick','7B rue Gay Lussac','62000','ARRAS','1997-08-29',NULL,'SW',0,'ptiphagn','azerty',NULL),('t55','Tréhet','Alain','7D chemin Barral','12000','RODEZ','1994-11-29',NULL,'SW',0,'atréhet1','azerty',NULL),('t60','Tusseau','Josselin','63 rue Bon Repos','28000','CHARTRES','1991-03-29',NULL,'GY',0,'jtusseau','azerty',NULL);
...
-- Dump completed on 2017-05-13 23:39:46
